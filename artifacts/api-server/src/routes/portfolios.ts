 ...
 *
 * Phase 3: Portfolio management endpoints.
 *
 * GET    /portfolios                            — list portfolios for an org
 * POST   /portfolios                            — create a portfolio
 * GET    /portfolios/:id/holdings               — list holdings
 * POST   /portfolios/:id/holdings/csv           — ingest CSV holdings
 * GET    /portfolios/:id/exposure-alerts        — exposure alerts grouped by issuer
